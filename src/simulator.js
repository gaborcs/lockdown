...
export function simulate(initialState, dailyTransitionRates, lockdownPeriod, lastDay) {
    let { transmissionWithoutLockdown, transmissionWithLockdown, recovery, death } = dailyTransitionRates;
    let states = [];
